...
resource "aws_instance" "red5pro_node_origin" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "export NODE_CLOUDSTORAGE_ENABLE='${origin_image_red5pro_cloudstorage_enable}'",
      "export NODE_CLOUDSTORAGE_AWS_ACCESS_KEY='${origin_image_red5pro_cloudstorage_aws_access_key}'",
      "export NODE_CLOUDSTORAGE_AWS_SECRET_KEY='${origin_image_red5pro_cloudstorage_aws_secret_key}'",
      "export NODE_CLOUDSTORAGE_AWS_BUCKET_NAME='${origin_image_red5pro_cloudstorage_aws_bucket_name}'",
      "export NODE_CLOUDSTORAGE_AWS_REGION='${origin_image_red5pro_cloudstorage_aws_region}'",
      "export NODE_CLOUDSTORAGE_POSTPROCESSOR_ENABLE='${origin_image_red5pro_cloudstorage_postprocessor_enable}'",
      "cd /home/ubuntu/red5pro-installer/",
      "sudo chmod +x /home/ubuntu/red5pro-installer/*.sh",
      "sudo -E /home/ubuntu/red5pro-installer/r5p_install_server_basic.sh",
...
resource "aws_instance" "red5pro_node_transcoder" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "export NODE_CLOUDSTORAGE_ENABLE='${transcoder_image_red5pro_cloudstorage_enable}'",
      "export NODE_CLOUDSTORAGE_AWS_ACCESS_KEY='${transcoder_image_red5pro_cloudstorage_aws_access_key}'",
      "export NODE_CLOUDSTORAGE_AWS_SECRET_KEY='${transcoder_image_red5pro_cloudstorage_aws_secret_key}'",
      "export NODE_CLOUDSTORAGE_AWS_BUCKET_NAME='${transcoder_image_red5pro_cloudstorage_aws_bucket_name}'",
      "export NODE_CLOUDSTORAGE_AWS_REGION='${transcoder_image_red5pro_cloudstorage_aws_region}'",
      "export NODE_CLOUDSTORAGE_POSTPROCESSOR_ENABLE='${transcoder_image_red5pro_cloudstorage_postprocessor_enable}'",
      "cd /home/ubuntu/red5pro-installer/",
      "sudo chmod +x /home/ubuntu/red5pro-installer/*.sh",
      "sudo -E /home/ubuntu/red5pro-installer/r5p_install_server_basic.sh",
      "sudo -E /home/ubuntu/red5pro-installer/r5p_config_node.sh",
