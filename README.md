...
module "red5pro" {
  ...
  https_letsencrypt_certificate_domain_name  = "terra-single-server.example.com" # Domain name for Let's Encrypt SSL certificate
...
module "red5pro" {
  ...
  https_certificate_manager_certificate_name = "terra-sm-auto.example.com"       # Domain name for your SSL certificate
