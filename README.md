...
* To create Red5 Pro Stream Manager autoscaling nodes you need to create node group manualy using Stream Manager API (https://qa-site.red5pro.com/docs/development/rest-api-v-400/overview/#gatsby-focus-wrapper)
