...
variable "https_aws_certificate_manager_use_existing" {
  description = "Use existing AWS Certificate Manager certificate (autoscaling)"
  type        = bool
  default     = false
}
variable "https_aws_certificate_manager_certificate_name" {
